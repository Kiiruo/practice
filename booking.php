        ...
        <form id="bookingForm" method="POST">
            <div class="flex">
                <div class="inputBox">
                    ...
                    <input type="text" id="name" name="name" required placeholder="Введите ваше имя" maxlength="30"
                        pattern="^[А-Яа-яЁё]+$" oninvalid="setCustomValidity('Введите имя на русском языке')">
                </div>
                <div class="inputBox">
                    <label for="phone">Номер телефона:</label>
                    <input type="tel" id="phone" name="phone" required placeholder="Введите ваш номер телефона" required
                        minlength="11" maxlength="11" pattern="^8\d{10}$">
                </div>
                <div class="inputBox">
                    <label for="email">Почта:</label>
                    <input type="email" id="email" name="email" required placeholder="Введите вашу эл. почту"
                        maxlength='50'>
                </div>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    ...
                    <input type="number" id="passengers" name="passengers" min="1" required
                        placeholder="Введите число пасажиров">
                </div>
                <div class="inputBox">
